...
<body class="antialiased">
    <div class="bg-white">
            ...
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                @if (Route::has('login'))
                    <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                        ...
                        @else
                            <a href="{{ route('login') }}"
                                class="text-sm font-semibold leading-6 text-gray-900 pr-2">Register</a>
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="text-sm font-semibold leading-6 text-gray-900">Log
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl py-28 sm:py-32 lg:py-36">
            ...
            <div class="absolute inset-x-0 top-[calc(50%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(80%-30rem)]"
                aria-hidden="true">
